...
let handler = async (m, { conn, groupMetadata }) => {
  ...
  if (participantes.length < 4) {
    return m.reply('🎀✨ *Dollie Bot* ✨🎀\n\nAy nooo ~ Necesito mínimo 4 personitas en el grupo para formar 2 parejitas lindas 💌')
  }
  ...
  // Armar el mensaje
  let texto = `🎀 *DOLLIE BOT - AGENCIA DEL AMOR* 🎀\n\n`
  texto += `✧ Cupido acaba de lanzar sus flechitas... ✧\n\n`
  ...
  texto += `🌸 Que florezca el amor... o al menos el chisme bonito 🌸\n`
  texto += `✨ Hecho con mucho glitter por *Dollie Bot* ✨`
